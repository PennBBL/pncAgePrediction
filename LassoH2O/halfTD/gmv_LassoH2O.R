...
colnames(xy_td_train_F)[118] <- "ageAtScan1"
xy_td_test_F <- cbind(x_td_test_F, y_td_test_F)
colnames(xy_td_test_F)[118] <- "ageAtScan1"
xy_ps_F <- cbind(x_ps_F, y_ps_F)
colnames(xy_ps_F)[118] <- "ageAtScan1"
...
colnames(xy_td_train_M)[118] <- "ageAtScan1"
xy_td_test_M <- cbind(x_td_test_M, y_td_test_M)
colnames(xy_td_test_M)[118] <- "ageAtScan1"
xy_ps_M <- cbind(x_ps_M, y_ps_M)
colnames(xy_ps_M)[118] <- "ageAtScan1"
...
# Save plots
pdf(file="/home/butellyn/age_prediction/plots/gmv_TDtest_LassoH2O.pdf", width=12, height=6)
