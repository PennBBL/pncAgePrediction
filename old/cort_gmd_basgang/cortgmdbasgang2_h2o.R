...
vol_df <- df[,c("mprage_jlf_vol_R_Thalamus_Proper", "mprage_jlf_vol_L_Thalamus_Proper", "mprage_jlf_vol_R_Putamen", "mprage_jlf_vol_L_Putamen", "mprage_jlf_vol_R_Caudate", "mprage_jlf_vol_L_Caudate", "mprage_jlf_vol_R_Pallidum", "mprage_jlf_vol_L_Pallidum", "mprage_jlf_vol_R_Accumbens_Area", "mprage_jlf_vol_L_Accumbens_Area", "mprage_jlf_vol_R_PHG", "mprage_jlf_vol_L_PHG", "mprage_jlf_vol_R_Hippocampus" , "mprage_jlf_vol_L_Hippocampus", "mprage_jlf_vol_R_PIns", "mprage_jlf_vol_L_PIns", "mprage_jlf_vol_R_SCA", "mprage_jlf_vol_L_SCA", "mprage_jlf_vol_R_AIns", "mprage_jlf_vol_L_AIns", "mprage_jlf_vol_R_ACgG", "mprage_jlf_vol_L_ACgG", "mprage_jlf_vol_R_PCgG", "mprage_jlf_vol_L_PCgG", "mprage_jlf_vol_R_Ent", "mprage_jlf_vol_L_Ent", "mprage_jlf_vol_R_Amygdala", "mprage_jlf_vol_L_Amygdala", "mprage_jlf_vol_R_MCgG", "mprage_jlf_vol_L_MCgG")]

df2 <- averageLeftAndRight_Vol(vol_df, rightString="_R_", leftString="_L_", averageString="_ave_")
df2 <- df2[,c("mprage_jlf_vol_ave_Thalamus_Proper", "mprage_jlf_vol_ave_Putamen", "mprage_jlf_vol_ave_Caudate", "mprage_jlf_vol_ave_Pallidum","mprage_jlf_vol_ave_Accumbens_Area",  "mprage_jlf_vol_ave_PHG", "mprage_jlf_vol_ave_Hippocampus" , "mprage_jlf_vol_ave_PIns","mprage_jlf_vol_ave_SCA", "mprage_jlf_vol_ave_AIns", "mprage_jlf_vol_ave_ACgG", "mprage_jlf_vol_ave_PCgG", "mprage_jlf_vol_ave_Ent",  "mprage_jlf_vol_ave_Amygdala", "mprage_jlf_vol_ave_MCgG")]
...
var_front_ct <- RowVar(df[,c('mprage_jlf_ct_L_FO', 'mprage_jlf_ct_R_FO', 'mprage_jlf_ct_L_MFC', 'mprage_jlf_ct_R_MFC', 'mprage_jlf_ct_L_MOrG', 'mprage_jlf_ct_R_MOrG', 'mprage_jlf_ct_L_POrG', 'mprage_jlf_ct_R_POrG', 'mprage_jlf_ct_L_OrIFG', 'mprage_jlf_ct_R_OrIFG', 'mprage_jlf_ct_L_TrIFG', 'mprage_jlf_ct_R_TrIFG', 'mprage_jlf_ct_L_AOrG', 'mprage_jlf_ct_R_AOrG', 'mprage_jlf_ct_L_OpIFG', 'mprage_jlf_ct_R_OpIFG', 'mprage_jlf_ct_L_GRe', 'mprage_jlf_ct_R_GRe', 'mprage_jlf_ct_L_FRP', 'mprage_jlf_ct_R_FRP', 'mprage_jlf_ct_L_LOrG', 'mprage_jlf_ct_R_LOrG', 'mprage_jlf_ct_L_PrG', 'mprage_jlf_ct_R_PrG', 'mprage_jlf_ct_L_MSFG', 'mprage_jlf_ct_R_MSFG', 'mprage_jlf_ct_L_SMC', 'mprage_jlf_ct_R_SMC', 'mprage_jlf_ct_L_MFG', 'mprage_jlf_ct_R_MFG', 'mprage_jlf_ct_L_SFG', 'mprage_jlf_ct_R_SFG')])
df$var_front_ct <- var_front_ct

# 7) # yes
var_parietal_ct <- RowVar(df[,c('mprage_jlf_ct_L_PCu', 'mprage_jlf_ct_R_PCu', 'mprage_jlf_ct_L_PoG', 'mprage_jlf_ct_R_PoG', 'mprage_jlf_ct_L_AnG', 'mprage_jlf_ct_R_AnG', 'mprage_jlf_ct_L_PO', 'mprage_jlf_ct_R_PO', 'mprage_jlf_ct_L_SPL', 'mprage_jlf_ct_R_SPL', 'mprage_jlf_ct_L_MPrG', 'mprage_jlf_ct_R_MPrG', 'mprage_jlf_ct_L_SMG', 'mprage_jlf_ct_R_SMG', 'mprage_jlf_ct_L_MPoG', 'mprage_jlf_ct_R_MPoG')])
df$var_parietal_ct <- var_parietal_ct
...
xvars <- c(cortvars, gmdvars, gmvvars)

# Ratio of frontal to temporal thickness, lobular cortical thickness, whole brain gmd, averaged subcortical volume, variability in frontal lobe and parietal cortical thickness (CV MSE of 1000 w/ 15 predictors)######
xvars <- c("var_front_ct", "var_parietal_ct", "mprage_jlfHiLoLobe_ct_Frontal_Orbital", "mprage_jlfHiLoLobe_ct_Frontal_Dorsal", "mprage_jlfHiLoLobe_ct_Temporal", "mprage_jlfHiLoLobe_ct_Parietal", "mprage_jlfHiLoLobe_ct_Occipital",  "mprage_jlfHiLoLobe_vol_Cerebellum", "mprage_jlf_gmd_MeanGMD", "mprage_jlf_vol_ave_Thalamus_Proper", "mprage_jlf_vol_ave_Putamen", "mprage_jlf_vol_ave_Caudate", "mprage_jlf_vol_ave_Pallidum","mprage_jlf_vol_ave_Accumbens_Area",  "mprage_jlf_vol_ave_PHG", "mprage_jlf_vol_ave_Hippocampus" , "mprage_jlf_vol_ave_PIns","mprage_jlf_vol_ave_SCA", "mprage_jlf_vol_ave_AIns", "mprage_jlf_vol_ave_ACgG", "mprage_jlf_vol_ave_PCgG", "mprage_jlf_vol_ave_Ent",  "mprage_jlf_vol_ave_Amygdala", "mprage_jlf_vol_ave_MCgG")
...
mod <- h2o.automl(x = xvars, y = "y_td_F", training_frame = h2o_td_F, max_runtime_secs = 3600, project_name=paste("a",runif(1),runif(1),sep=""))
...
# Summary Dataframes
# lasso
summary_lasso_F <- data.frame(matrix(0, nrow=16, ncol=4))
colnames(summary_lasso_F) <- c("Age_Category", "Diagnosis", "Percent_Pred_Adult", "N")
summary_lasso_F$Age_Category <- c("8_9", "8_9", "10_11", "10_11", "12_13", "12_13", "14_15", "14_15", "16_17", "16_17", "18_19", "18_19", "20_21", "20_21", "22_23", "22_23")
summary_lasso_F$Diagnosis <- c("TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS")
...
TD_20_21 <- 100*(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_lasso == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD", "age_cat"]))
PS_20_21 <- 100*(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_lasso == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS", "age_cat"]))
TD_22_23 <- 100*(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_lasso == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD", "age_cat"]))
PS_22_23 <- 100*(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_lasso == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS", "age_cat"]))
summary_lasso_F$Percent_Pred_Adult <- c(TD_8_9, PS_8_9, TD_10_11, PS_10_11, TD_12_13, PS_12_13, TD_14_15, PS_14_15, TD_16_17, PS_16_17, TD_18_19, PS_18_19, TD_20_21, PS_20_21, TD_22_23, PS_22_23)
...
N_TD_20_21 <- paste0(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_lasso == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD", "age_cat"]))
N_PS_20_21 <- paste0(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_lasso == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS", "age_cat"]))
N_TD_22_23 <- paste0(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_lasso == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD", "age_cat"]))
N_PS_22_23 <- paste0(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_lasso == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS", "age_cat"]))
summary_lasso_F$N <- c(N_TD_8_9, N_PS_8_9, N_TD_10_11, N_PS_10_11, N_TD_12_13, N_PS_12_13, N_TD_14_15, N_PS_14_15, N_TD_16_17, N_PS_16_17, N_TD_18_19, N_PS_18_19, N_TD_20_21, N_PS_20_21, N_TD_22_23, N_PS_22_23)


summary_lasso_F$Age_Category <- factor(summary_both_F$Age_Category, levels = c("8_9", "10_11", "12_13", "14_15", "16_17", "18_19", "20_21", "22_23"))

#h20
summary_h2o_F <- data.frame(matrix(0, nrow=16, ncol=4))
colnames(summary_h2o_F) <- c("Age_Category", "Diagnosis", "Percent_Pred_Adult", "N")
summary_h2o_F$Age_Category <- c("8_9", "8_9", "10_11", "10_11", "12_13", "12_13", "14_15", "14_15", "16_17", "16_17", "18_19", "18_19", "20_21", "20_21", "22_23", "22_23")
summary_h2o_F$Diagnosis <- c("TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS", "TD", "PS")
...
TD_20_21 <- 100*(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_h2o == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD", "age_cat"]))
PS_20_21 <- 100*(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_h2o == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS", "age_cat"]))
TD_22_23 <- 100*(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_h2o == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD", "age_cat"]))
PS_22_23 <- 100*(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_h2o == 1, "age_cat"])/length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS", "age_cat"]))
summary_h2o_F$Percent_Pred_Adult <- c(TD_8_9, PS_8_9, TD_10_11, PS_10_11, TD_12_13, PS_12_13, TD_14_15, PS_14_15, TD_16_17, PS_16_17, TD_18_19, PS_18_19, TD_20_21, PS_20_21, TD_22_23, PS_22_23)
...
N_TD_20_21 <- paste0(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_h2o == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "TD", "age_cat"]))
N_PS_20_21 <- paste0(length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_h2o == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "20_21" & df_both_F$diagnosis == "PS", "age_cat"]))
N_TD_22_23 <- paste0(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD" & df_both_F$pred_adult_h2o == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "TD", "age_cat"]))
N_PS_22_23 <- paste0(length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS" & df_both_F$pred_adult_h2o == 1, "age_cat"]),"/",length(df_both_F[df_both_F$age_cat == "22_23" & df_both_F$diagnosis == "PS", "age_cat"]))
summary_h2o_F$N <- c(N_TD_8_9, N_PS_8_9, N_TD_10_11, N_PS_10_11, N_TD_12_13, N_PS_12_13, N_TD_14_15, N_PS_14_15, N_TD_16_17, N_PS_16_17, N_TD_18_19, N_PS_18_19, N_TD_20_21, N_PS_20_21, N_TD_22_23, N_PS_22_23)

summary_h2o_F$Age_Category <- factor(summary_both_F$Age_Category, levels = c("8_9", "10_11", "12_13", "14_15", "16_17", "18_19", "20_21", "22_23"))
...
real_pred_lasso_F <- ggplot(data=df_both_F, aes(real_age, pred_age_lasso, color=diagnosis)) +
	...
	xlim(5,24) + ylim(5,24) + geom_abline() +
	labs(title = "Female (Lasso): CT/GMD/GMV ROIs", subtitle = substring_lasso_F) + 
...
real_pred_h2o_F <- ggplot(data=df_both_F, aes(real_age, pred_age_h2o, color=diagnosis)) +
	geom_point(shape = 16, size = 3, show.legend = TRUE) + theme_minimal() +
	xlim(5,24) + ylim(5,24) + geom_abline() +
	labs(title = "Female (H2O): CT/GMD/GMV ROIs", subtitle = substring_h2o_F) + 
	xlab("Real Age") + ylab("Predicted Age") +
	geom_smooth(se = TRUE, method = "gam", formula = y ~ s(log(x))) + 
	theme(plot.title = element_text(family="Times", face="bold", size=20))
...
bar_lasso_F <- ggplot(data=summary_lasso_F, aes(x=Age_Category, y=Percent_Pred_Adult, fill=Diagnosis)) +
	...
	ggtitle("Female (Lasso): CT/GMD/GMV ROIs") + xlab("Age Category") + ylab("Predicted Adult (%)")

bar_h2o_F <- ggplot(data=summary_h2o_F, aes(x=Age_Category, y=Percent_Pred_Adult, fill=Diagnosis)) +
	geom_bar(stat="identity", position=position_dodge()) +
	geom_text(aes(label=N), vjust=1.6, color="white", position = position_dodge(0.9), size=3.5) +
	scale_fill_brewer(palette="Paired") + ylim(c(0,100)) +
	ggtitle("Female (H2O): CT/GMD/GMV ROIs") + xlab("Age Category") + ylab("Predicted Adult (%)")
...
ps_real_pred_M <- ggplot(data=df_ps_M, aes(real_age, pred_age)) +
	geom_point(shape = 16, size = 5, show.legend = FALSE, color="cornflowerblue") + theme_minimal() +
	scale_color_gradient(low = "#0091ff", high = "#f0650e") + xlim(5,24) + ylim(5,24) + geom_abline() +
	ggtitle("PS Male: CT/GMD/DGMVOL Brain Age") + 
	xlab("Real Age") + ylab("Predicted Age")
...
td_real_pred_M <- ggplot(data=df_td_M, aes(real_age, pred_age)) +
	geom_point(shape = 16, size = 5, show.legend = FALSE, color="cornflowerblue") + theme_minimal() +
	scale_color_gradient(low = "#0091ff", high = "#f0650e") + xlim(5,24) + ylim(5,24) + geom_abline() +
	ggtitle("TD Male: CT/GMD/DGMVOL Brain Age") + 
	xlab("Real Age") + ylab("Predicted Age")
...
bar_M <- ggplot(data=summary_both_M, aes(x=Age_Category, y=Percent_Pred_Adult, fill=Diagnosis)) +
	...
	geom_text(aes(label=N), vjust=1.6, color="white", position = position_dodge(0.9), size=3.5) +
	scale_fill_brewer(palette="Paired") + ylim(c(0,100)) +
	ggtitle("Male Brain Age: CT/GMD/DGMVOL") + xlab("Age Category") + ylab("Predicted Adult (%)")



# Save plots
pdf(file="/home/butellyn/age_prediction/plots/cortgmdgmv_LassoH2O.pdf", width=10, height=6)
