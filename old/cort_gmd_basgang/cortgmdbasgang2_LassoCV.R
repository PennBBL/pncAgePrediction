...
#vol_df <- df[,c("mprage_jlfLobe_vol_R_Limbic_Lobe", "mprage_jlfLobe_vol_L_Limbic_Lobe", "mprage_jlfLobe_vol_R_Insular_Lobe", "mprage_jlfLobe_vol_L_Insular_Lobe", "mprage_jlfLobe_vol_R_Frontal_Lobe", "mprage_jlfLobe_vol_L_Frontal_Lobe", "mprage_jlfLobe_vol_R_Parietal_Lobe", "mprage_jlfLobe_vol_L_Parietal_Lobe", "mprage_jlfLobe_vol_R_Occipital_Lobe", "mprage_jlfLobe_vol_L_Occipital_Lobe", "mprage_jlfLobe_vol_R_Temporal_Lobe", "mprage_jlfLobe_vol_L_Temporal_Lobe")]
#cort_df <- df[,c("mprage_jlfLobe_ct_R_Limbic_Lobe", "mprage_jlfLobe_ct_L_Limbic_Lobe", "mprage_jlfLobe_ct_R_Insular_Lobe", "mprage_jlfLobe_ct_L_Insular_Lobe", "mprage_jlfLobe_ct_R_Frontal_Lobe", "mprage_jlfLobe_ct_L_Frontal_Lobe", "mprage_jlfLobe_ct_R_Parietal_Lobe", "mprage_jlfLobe_ct_L_Parietal_Lobe", "mprage_jlfLobe_ct_R_Occipital_Lobe", "mprage_jlfLobe_ct_L_Occipital_Lobe", "mprage_jlfLobe_ct_R_Temporal_Lobe", "mprage_jlfLobe_ct_L_Temporal_Lobe")]

#df2 <- averageLeftAndRight_WeightByVol(vol_df, cort_df, volString="_vol", otherString="_ct")
#df2 <- df2[,c("mprage_jlfLobe_ct_ave_Limbic_Lobe", "mprage_jlfLobe_ct_ave_Insular_Lobe", "mprage_jlfLobe_ct_ave_Frontal_Lobe", "mprage_jlfLobe_ct_ave_Parietal_Lobe", "mprage_jlfLobe_ct_ave_Occipital_Lobe", "mprage_jlfLobe_ct_ave_Temporal_Lobe")]
#df <- cbind(df, df2)

# Trial variables
# 1))# not related to age
df$cort_frontal_occipital <- (df$mprage_jlfLobe_ct_ave_Frontal_Lobe)/(df$mprage_jlfLobe_ct_ave_Occipital_Lobe)# not related to age
# 2) # maybe?
df$cort_frontal_temporal <- (df$mprage_jlfLobe_ct_ave_Frontal_Lobe)/(df$mprage_jlfLobe_ct_ave_Temporal_Lobe)
# 3) # not related to age
df$cort_frontal_parietal <- (df$mprage_jlfLobe_ct_ave_Frontal_Lobe)/(df$mprage_jlfLobe_ct_ave_Parietal_Lobe)
# 4) # not related to age
df$cort_frontal_insular <- (df$mprage_jlfLobe_ct_ave_Frontal_Lobe)/(df$mprage_jlfLobe_ct_ave_Insular_Lobe)
...
gmvvars <- c('mprage_jlf_vol_R_Accumbens_Area', 'mprage_jlf_vol_L_Accumbens_Area', 'mprage_jlf_vol_R_Amygdala', 
           'mprage_jlf_vol_L_Amygdala', 'mprage_jlf_vol_R_Caudate', 'mprage_jlf_vol_L_Caudate', 'mprage_jlf_vol_R_Cerebellum_Exterior', 
           'mprage_jlf_vol_L_Cerebellum_Exterior', 'mprage_jlf_vol_R_Hippocampus', 'mprage_jlf_vol_L_Hippocampus','mprage_jlf_vol_R_Pallidum', 
...
# 5) # not related to age
RowVar <- function(x, ...) {
  rowSums((x - rowMeans(x, ...))^2, ...)/(dim(x)[2] - 1)
}
var_ct <- RowVar(df[,cortvars])
df$var_ct <- var_ct
...
# 8) # no
var_temporal_ct <- RowVar(df[,c('mprage_jlf_ct_L_FuG', 'mprage_jlf_ct_R_FuG', 'mprage_jlf_ct_L_PT', 'mprage_jlf_ct_R_PT', 'mprage_jlf_ct_L_PP', 'mprage_jlf_ct_R_PP', 'mprage_jlf_ct_L_ITG', 'mprage_jlf_ct_R_ITG', 'mprage_jlf_ct_L_CO', 'mprage_jlf_ct_R_CO', 'mprage_jlf_ct_L_MTG', 'mprage_jlf_ct_R_MTG', 'mprage_jlf_ct_L_TMP', 'mprage_jlf_ct_R_TMP', 'mprage_jlf_ct_L_STG', 'mprage_jlf_ct_R_STG', 'mprage_jlf_ct_L_TTG', 'mprage_jlf_ct_R_TTG')])
df$var_temporal_ct <- var_temporal_ct
...
# Ratio of frontal to temporal thickness, lobular cortical thickness, whole brain gmd, subcortical volumes (CV MSE of 1000 w/ 30 predictors)
xvars <- c("cort_frontal_temporal", "mprage_jlfHiLoLobe_ct_Frontal_Orbital", "mprage_jlfHiLoLobe_ct_Frontal_Dorsal", "mprage_jlfHiLoLobe_ct_Temporal", "mprage_jlfHiLoLobe_ct_Parietal", "mprage_jlfHiLoLobe_ct_Occipital", "mprage_jlf_gmd_MeanGMD", "mprage_jlf_vol_R_Thalamus_Proper", "mprage_jlf_vol_L_Thalamus_Proper", "mprage_jlf_vol_R_Putamen", "mprage_jlf_vol_L_Putamen", "mprage_jlf_vol_R_Caudate", "mprage_jlf_vol_L_Caudate", "mprage_jlf_vol_R_Pallidum", "mprage_jlf_vol_L_Pallidum", "mprage_jlf_vol_R_Accumbens_Area", "mprage_jlf_vol_L_Accumbens_Area", "mprage_jlf_vol_R_PHG", "mprage_jlf_vol_L_PHG", "mprage_jlf_vol_R_Hippocampus" , "mprage_jlf_vol_L_Hippocampus", "mprage_jlf_vol_R_PIns", "mprage_jlf_vol_L_PIns", "mprage_jlf_vol_R_SCA", "mprage_jlf_vol_L_SCA", "mprage_jlf_vol_R_AIns", "mprage_jlf_vol_L_AIns", "mprage_jlf_vol_R_ACgG", "mprage_jlf_vol_L_ACgG", "mprage_jlf_vol_R_PCgG", "mprage_jlf_vol_L_PCgG", "mprage_jlf_vol_R_Ent", "mprage_jlf_vol_L_Ent", "mprage_jlf_vol_R_Amygdala", "mprage_jlf_vol_L_Amygdala", "mprage_jlf_vol_R_MCgG", "mprage_jlf_vol_L_MCgG", "mprage_jlfHiLoLobe_vol_Cerebellum")

# Ratio of frontal to temporal thickness, lobular cortical thickness, whole brain gmd
xvars <- c("cort_frontal_temporal", "mprage_jlfHiLoLobe_ct_Frontal_Orbital", "mprage_jlfHiLoLobe_ct_Frontal_Dorsal", "mprage_jlfHiLoLobe_ct_Temporal", "mprage_jlfHiLoLobe_ct_Parietal", "mprage_jlfHiLoLobect_Occipital",  "mprage_jlfHiLoLobe_vol_Cerebellum", "mprage_jlf_gmd_MeanGMD")

# Ratio of frontal to temporal thickness, lobular cortical thickness, whole brain gmd, some subcortical volumes
xvars <- c("cort_frontal_temporal", "mprage_jlfHiLoLobe_ct_Frontal_Orbital", "mprage_jlfHiLoLobe_ct_Frontal_Dorsal", "mprage_jlfHiLoLobe_ct_Temporal", "mprage_jlfHiLoLobe_ct_Parietal", "mprage_jlfHiLoLobe_ct_Occipital",  "mprage_jlfHiLoLobe_vol_Cerebellum", "mprage_jlf_gmd_MeanGMD", "mprage_jlf_vol_R_Amygdala", "mprage_jlf_vol_L_Amygdala", "mprage_jlf_vol_R_Hippocampus" , "mprage_jlf_vol_L_Hippocampus")

# Ratio of frontal to temporal thickness, lobular cortical thickness, whole brain gmd, averaged subcortical volume (CV MSE of 1000 w/ 15 predictors)
...
# Ratio of frontal to temporal thickness, lobular cortical thickness, whole brain gmd, averaged subcortical volume, variability in frontal lobe and parietal cortical thickness, gray matter volume (CV MSE of 1000 w/ 19 predictors)
xvars <- c("mprage_antsCT_vol_GrayMatter", "var_front_ct", "var_parietal_ct", "cort_frontal_temporal", "mprage_jlfHiLoLobe_ct_Frontal_Orbital", "mprage_jlfHiLoLobe_ct_Frontal_Dorsal", "mprage_jlfHiLoLobe_ct_Temporal", "mprage_jlfHiLoLobe_ct_Parietal", "mprage_jlfHiLoLobe_ct_Occipital",  "mprage_jlfHiLoLobe_vol_Cerebellum", "mprage_jlf_gmd_MeanGMD", "mprage_jlf_vol_ave_Thalamus_Proper", "mprage_jlf_vol_ave_Putamen", "mprage_jlf_vol_ave_Caudate", "mprage_jlf_vol_ave_Pallidum","mprage_jlf_vol_ave_Accumbens_Area",  "mprage_jlf_vol_ave_PHG", "mprage_jlf_vol_ave_Hippocampus" , "mprage_jlf_vol_ave_PIns","mprage_jlf_vol_ave_SCA", "mprage_jlf_vol_ave_AIns", "mprage_jlf_vol_ave_ACgG", "mprage_jlf_vol_ave_PCgG", "mprage_jlf_vol_ave_Ent",  "mprage_jlf_vol_ave_Amygdala", "mprage_jlf_vol_ave_MCgG")
...
ps_real_pred_F <- ggplot(data=df_ps_F, aes(real_age, pred_age)) +
	...
	ggtitle("PS Female: CT/GMD/DGMVOL Brain Age") + 
...
td_real_pred_F <- ggplot(data=df_td_F, aes(real_age, pred_age)) +
	geom_point(shape = 16, size = 5, show.legend = FALSE, color="cornflowerblue") + theme_minimal() +
	scale_color_gradient(low = "#0091ff", high = "#f0650e") + xlim(5,24) + ylim(5,24) + geom_abline() +
	ggtitle("TD Female: CT/GMD/DGMVOL Brain Age") + 
	xlab("Real Age") + ylab("Predicted Age")
...
bar_F <- ggplot(data=summary_both_F, aes(x=Age_Category, y=Percent_Pred_Adult, fill=Diagnosis)) +
	...
	ggtitle("Female Brain Age:  CT/GMD/DGMVOL") + xlab("Age Category") + ylab("Predicted Adult (%)")
...
# Save plots
pdf(file="/home/butellyn/age_prediction/plots/cortgmdbasgang2_LassoCV.pdf", width=10, height=6)
